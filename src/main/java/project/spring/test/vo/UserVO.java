package project.spring.test.vo;
...
public class UserVO {
	...
	public void setUser_profileImagePath(
			String user_profileImagePath) {
	...
	public void setUser_authStatus(
			String user_authStatus) {
	...
	public UserVO(String user_id,
			...
			String user_password,
			String user_profileImagePath,
			int user_sex, String user_birth,
			String user_job,
			String user_phoneNumber,
			String user_authCode,
			String user_authStatus,
			String user_isTutor,
			String user_status, String pageNumber,
			String rnum, Date user_log, int ages,
			int age_count, int user_isAdmin,
			int unReadCount) {
		super();
		this.user_id = user_id;
		this.user_email = user_email;
